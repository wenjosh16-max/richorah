                    ...
                    >
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-2">
                          <span className="font-medium text-[#1A1A2E] truncate max-w-[200px] block">
                            {bien.titre}
                          </span>
                          {needsUpdate && (
                            <span title="Non mis à jour depuis 30+ jours"><AlertTriangle className="h-4 w-4 text-red-500 flex-shrink-0" /></span>
                          )}
                          {bien.promotions.length > 0 && (
                            <Badge variant="warning" className="text-[10px]">
                              -{bien.promotions[0].promotion.reduction}%
                            </Badge>
                          )}
                        </div>
                      </td>
                      ...
                      <td className="px-4 py-3">
                        <form action={changeStatut.bind(null, bien.id, cycleStatut(bien.statut))}>
                          <button type="submit" className="cursor-pointer">
                            <Badge
                              variant={(STATUT_BADGE[bien.statut] || "secondary") as "default" | "secondary" | "success" | "warning" | "danger" | "info" | "outline"}
                      ...
                      <td className="px-4 py-3">
                        <a
                          ...
                          className="inline-flex text-gray-400 hover:text-[#FF385C] transition-colors"
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-1">
                          <Link
                            ...
                            className="p-1.5 text-gray-400 hover:text-[#FF385C] transition-colors rounded-md hover:bg-[#F8F7F4]"
                            title="Modifier"
                          >
